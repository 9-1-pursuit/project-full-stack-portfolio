...
- Use [ChatGPT](https://chat.openai.com/auth/login) to create seed information for your database. (Include a screenshot or screenshots of the prompts in your README.md)
